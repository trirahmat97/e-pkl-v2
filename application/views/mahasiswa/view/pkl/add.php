    ...
    <section class="content">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Add Data Perusahaan</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <?php
            ...
            <?php } ?>
            <form class="form-horizontal" action="<?= base_url('mahasiswa/pkl/create'); ?>" method="post">
                <div class="card-body">
                    <div class="form-group row">
                        <label for="name" class="col-sm-2 col-form-label">Nama Perusahaan</label>
                        <div class="col-sm-10">
                            <input type="text" name="name" class="form-control" id="name" required placeholder="Nama Perusahaan">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="telphon" class="form-control" id="telphon" required placeholder="telphon">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="username" class="col-sm-2 col-form-label">provinsi</label>
                        <div class="col-sm-10">
                            <input type="text" name="provinsi" class="form-control" id="provinsi" required placeholder="provinsi">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="username" class="col-sm-2 col-form-label">kabupaten</label>
                        <div class="col-sm-10">
                            <input type="text" name="kabupaten" class="form-control" id="kabupaten" required placeholder="kabupaten">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="username" class="col-sm-2 col-form-label">kecamatan</label>
                        <div class="col-sm-10">
                            <input type="text" name="kecamatan" class="form-control" id="kecamatan" required placeholder="kecamatan">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="username" class="col-sm-2 col-form-label">Kode Pos</label>
                        <div class="col-sm-10">
                            <input type="text" name="kode_pos" class="form-control" id="kode_pos" required placeholder="Kode Pos">
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-info">Create Perusahaan</button>
